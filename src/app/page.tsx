...
const projects = [
  {
    id: 1,
    number: '01',
    title: 'DOMS Development of an Operation Management System for SSS',
    ...
    imageSrc: '/proj/one.png', 
    link: 'https://github.com/chizuro101/eBarangay_Portal',
  },
  {
    id: 2,
    number: '02',
    title: 'Tanjay City: Requesting Documents',
    description: 'Web Developer',
    techstack: [
  ...
  },
  {
    ...
    link: 'https://github.com/chizuro101/payroll',
  },
  {
    id: 4,
    number: '04',
    ...
    imageSrc: '/proj/four.png',
    link: 'https://github.com/chizuro101/BIKESHOP',
  },
  {
    id: 5,
    number: '05', 
    ...
    imageSrc: '/proj/five.png',
    link: 'https://github.com/chizuro101/basketball-club', 
  },
  {
    id: 6,
    number: '06',
    ...
    <> {/* Added React Fragment wrapper */}
      ...
      <main className="flex-grow flex flex-col items-center h-full relative pt-20"> {/* Added padding top to account for fixed header */}
        ...
        <div className="font-bold text-center opacity-0 animate-fadeIn mt-1 md:mt-3">
          <TrueFocus
            sentence="Developer   GraphicDesigner   AI-DataAnnotator"
            manualMode={true}
            blurAmount={5}
            borderColor="cyan"
        ...
        <div className="flex-grow flex flex-col md:flex-row items-center justify-center w-full md:w-9xl md:mt-35 mt-10 md:space-x-50 space-x-0">
          ...
          <div className="flex flex-col">
            ...
            <div className="hidden md:block mt-10 mb-20">
              <TiltedCard
                imageSrc="/photos/download.jpg"
                altText="Yuyuhiei"
                captionText="Delacruz, Johnmark Q." 
      ...
      <footer className="flex w-full items-center justify-center p-4 border-t border-white/[.15] text-white/50 text-sm font-light mt-20"> {/* Added margin top */}
        <p>&copy; {new Date().getFullYear()} Delacruz, Johnmark Q.. All rights reserved.</p> {/* Updated name */}
      </footer>
